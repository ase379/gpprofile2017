...
- [VirtualTreeView](https://github.com/JAM-Software/Virtual-TreeView) as a high performance list and tree view implementation. Its a submodule in 'libs'. You need to compile the design package and add it to the IDE.
- [SynEdit](https://github.com/TurboPack/SynEdit) for the source code view. Its a submodule in 'libs' in the older versions. Use GetIt if the folder is not there. Install the design packages.
